...
`r table(UCBTab$Admit)[[1]]` of `r sum(table(UCBTab$Admit))` were admitted.  Now let's calculate the probability of admission just based on the data.  This proportion will later appear as $\hat{p}$.
