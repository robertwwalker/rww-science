...
Most data types are represented.  There is no time variable so dates and the visualizations that go with time series are omitted.  `kableExtra` is necessary to render my tables.

---

# Playing Along

I work from a template.  [You can access it here.](https://github.com/robertwwalker/DADMStuff/raw/master/GraphingTemplate.Rmd)
