...
<iframe src="https://prezi.com/p/ncfkd5tn8xul/embed/" id="iframe_container" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" allow="autoplay; fullscreen" height="600" width="1100"></iframe>
...
```{r Fig1, eval=FALSE, message=FALSE, warning=FALSE, display_type="output", include=FALSE, results='hide'}
...
```{r Box1, eval=FALSE, message=FALSE, warning=FALSE, display_type="output", include=FALSE, results='hide'}
...
```{r RTC, eval=FALSE, message=FALSE, warning=FALSE, display_type="output", include=FALSE, results='hide'}
Bonds %>% 
  group_by(Type,Risk) %>% 
  summarise(Count = n()) %>% 
...
You can send me email showing that you have completed these exercises.  More on this in the lab.
...
5. You will practice basic summary and other basic features of R in the lab assignment for this week.  
--

6. There is a worked example in `Resources > R Documents > Import from Excel` to work with.
