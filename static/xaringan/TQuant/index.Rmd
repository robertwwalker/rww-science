...
knitr::opts_chunk$set(warning=FALSE, message=FALSE, comment="", cache=FALSE, fig.height=6, fig.width=6.5, fig.retina = 3, dev = 'svg', dev.args = list(bg = "transparent"))
# style_mono_accent(
style_duo_accent(
...
.remark-code{line-height: 1; font-size: 80%}
@media print {
  .has-continuation {
    display: block;
  }
