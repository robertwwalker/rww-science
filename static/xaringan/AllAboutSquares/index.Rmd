...
knitr::opts_chunk$set(warning=FALSE, message=FALSE, comment=NA, prompt=TRUE, fig.height=6, fig.width=6.5, fig.retina = 3, dev = 'svg', dev.args = list(bg = "transparent"))
...
```{r}
ggplot(OregonSalaries) + aes(x=Gender, y=Salary) + geom_boxplot()
```
