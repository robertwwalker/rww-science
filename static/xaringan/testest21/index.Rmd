...
anim_save(SaveAnim, renderer = gifski_renderer(height=500, width=1000), filename=here("static/xaringan/testest21","Anim1.gif"))
```
.center[
![](./Anim1.gif)
]
...
ggsave(BasePlot, filename="BaseDensity.svg", device="svg", path=here("testest21/images"))
```
