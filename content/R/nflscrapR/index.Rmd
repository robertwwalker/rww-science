...
I will stop with that for this blog post, I did a bit more with this and also [built a shiny app for doing it for all of the teams](https://rwalkerwu.shinyapps.io/NFL-Scrapr/) that is linked there.
