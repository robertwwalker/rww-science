...
ggp <- ggplotly(Res1)
library(htmlwidgets)
htmlwidgets::saveWidget(ggp, file=paste0(here('/content/R/COVID/data/today.html')))
```
<iframe src="https://rww.science/R/COVID/data/today.html" width=1000 height=800"></iframe>
