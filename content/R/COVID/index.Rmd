...
This post is current as of July 28, 2020; this first bit of R code loads the current data from my github.
...
OR.Testing <- Oregon.Tests %>% group_by(date) %>% summarise(Total = sum(Outcome, na.rm=TRUE)) %>% filter(date > "2020-07-01")
