...
```{r}
# load(url(paste0("https://github.com/robertwwalker/rww-science/raw/master/content/R/COVID/data/OregonCOVID",Sys.Date()-1,".RData")))
load("~/Sandbox/awful/content/R/COVID/data/OregonCOVID2020-03-29.RData")
```
...
Test1 <- Oregon.Tests %>% 
  ...
  geom_col() + 
  geom_label(col="magenta", show.legend = FALSE, vjust=1) + 
  ...
  geom_label(data=OR.Testing, aes(x=date, y=Total+100, label=Total), fill="white", color="black", inherit.aes = FALSE, vjust = 0)
Test1
```
