...
```{r}
load(url("https://rww.science/r/covid/data/OregonCOVID2020-03-24.RData"))
```
...
Map.Me <- Map.Me %>% mutate(TTip = paste0("Deaths: ",Deaths,"<br> Negative .sts:",Negative.test.results))
Res.1 <- Map.Me %>% filter(date=="2020-03-24") %>%
