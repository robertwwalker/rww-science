...
This post is current as of May 28, 2020; this first bit of R code loads the current data from my github.
...
load("data/CountyMap.RData")
Map.Me <- merge(counties.t,Oregon.COVID, by.x="NAME", by.y = "County")
Res.1 <- Map.Me %>% 
