...
```{r}
Age1 <- OR.Ages %>% ggplot(., aes(x=date, y=Number.of.cases, fill=Age.group)) + geom_col() + scale_fill_ipsum() + labs(x="Date", y="Number of COVID-19 Positives") + theme_economist() + guides(fill=FALSE)
Age2 <- OR.Ages %>% ggplot(.) +
