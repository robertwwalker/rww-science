...
This post is current as of May 24, 2020; this first bit of R code loads the current data from my github.
...
```{r MapC, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
