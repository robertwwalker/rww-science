...
This post is current as of August 14, 2020; this first bit of R code loads the current data from my github.
...
*2020-08-20* There is no apparent update via the waybackmachine and the only data appears to be in a .pdf report.
...
Test1 <- Oregon.Tests %>% filter(date > "2020-07-01") %>%
  ggplot(.) + 
  ...
  scale_fill_viridis_d() + 
#  scale_color_viridis_d() + 
  labs(title="Cumulative [since January 2020] COVID-19 Testing in Oregon \n Shown from July 1", y="Completed Tests", x="Date", subtitle="Total appears in black and white", caption = "data: https://govstatus.egov.com/OR-OHA-COVID-19") + 
  guides(fill=FALSE) +
