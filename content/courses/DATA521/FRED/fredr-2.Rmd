...
`fredr` has a search capability.  Let's see what we can find; I will look at real estate charge offs.
...
library(ggrepel)
library(tidyr)
pl2 <- SubPrime.OR %>% ggplot(aes(x=date, y=value, colour=series_id)) +
  geom_line() + 
