...
gg1 <- ggplot(pizzaData, aes(x=reorder(name,PriceAvg), fill=PriceAvg)) +
  ...
  labs(x="Pizza Restaurant", y="Count", caption = "data from #tidyTuesday; sorted by Average Price") 
# Build the map
...
girafe( code = print(gg1 + gg2 + plot_annotation(title="Pizza in Oregon")), width_svg = 8, height_svg = 4)
```
