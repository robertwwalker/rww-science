...
summary: ''
authors: []
lastmod: '2020-03-23T15:46:49-07:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
I now have a few days of data.  The scraping script appears at the bottom of the post; I am only using the county level data.  These data are current as of March 23, 2020.

```{r}
load("~/Sandbox/awful/content/post/2020-03-22-covid-19-county-maps-for-oregon/OregonCOVID2020-03-23.RData")
```
...
I will use a ggplot to build Oregon's map and fill it with case numbers.  I have to project the map off of the natural angle in the basic data, repel the labels to prevent print overlap, and scheme the colors.  The last step is to animate it by time.
...
OHA.Corona.4 <- function(website, date) {
...
# March 18 Update
Mar18 <- OHA.Corona.3(website="https://web.archive.org/web/20200319144434/https://govstatus.egov.com/OR-OHA-COVID-19", date="2020-03-18")
# March 19 Update
Mar19 <- OHA.Corona.3(website="https://web.archive.org/web/20200320152224/https://govstatus.egov.com/OR-OHA-COVID-19", date="2020-03-19")
# March 20 Update
Mar20 <- OHA.Corona.3(website="https://web.archive.org/web/20200320202955/https://govstatus.egov.com/OR-OHA-COVID-19", date="2020-03-20")
# March 21 Update
...
# March 23 Update
Mar23 <- OHA.Corona.4(website="https://govstatus.egov.com/OR-OHA-COVID-19", date="2020-03-23")
```
