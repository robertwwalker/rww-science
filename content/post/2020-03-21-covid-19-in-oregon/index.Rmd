...
Oregon.COVID.0321 <- Oregon.COVID.0321 %>% mutate(PTT = paste("Cases:",Number.of.cases,"<br> Deaths:",Deaths,"<br>Negative Tests:",Negative.test.results, sep=""), date="2020-03-21")
...
Oregon.COVID.0322 <- Oregon.COVID.0322 %>% mutate(PTT = paste("Cases:",Number.of.cases,"<br> Deaths:",Deaths,"<br>Negative Tests:",Negative.test.results, sep=""), date="2020-03-22")
Oregon.COVID <- bind_rows(Oregon.COVID.0321,Oregon.COVID.0322)
# Oregon.COVID <- Oregon.COVID.0321
...
```{r, eval=FALSE}
library(leaflet)
m <- leaflet() %>% setView(lat=43.8041, lng=-120.5542, zoom=6) %>% addTiles() 
m
```
...
library(rgdal)
library(sf)
County.bounds <- shapefiles::read.shapefile("~/Downloads/orotl")
County.bounds
```
