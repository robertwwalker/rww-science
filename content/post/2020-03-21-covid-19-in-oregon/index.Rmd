...
The Oregon data are available from OHA [here](https://govstatus.egov.com/OR-OHA-COVID-19).  I cut and pasted the first two days because it was easy with `datapasta`.  As it goes one, it was easier to write a script.
