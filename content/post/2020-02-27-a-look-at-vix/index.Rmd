...
p <- ggplot(VIX, aes(x=Dates, y=Percent.Change)) + geom_line() + geom_vline(xintercept = as.Date("02/27/2020", format = "%m/%d/%Y"), color="red", alpha=0.2, linetype = "dotted") + geom_vline(xintercept = as.Date("09/12/2008", format = "%m/%d/%Y"), color="red", alpha=0.2) + ggthemes::theme_economist() + geom_label(data = data.frame(x = as.Date("2008-02-12"),
y = 4,
