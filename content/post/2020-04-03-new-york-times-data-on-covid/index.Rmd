...
WCStates <- Rect.NYT %>% filter(date=="2020-04-08") %>% top_n(5, wt=New.Cases) %>% mutate(Top5 = 1)
...
CFR2 <- Rect.NYT %>% filter(date == "2020-04-08") %>% mutate(CFR = round(deaths / cases, digits=3), State = state, state = tolower(State))
