...
summary: ''
authors: []
lastmod: '2020-04-07T20:04:06-07:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
WCStates <- Rect.NYT %>% filter(date=="2020-04-06") %>% top_n(5, wt=New.Cases) %>% mutate(Top5 = 1)
...
CFR2 <- Rect.NYT %>% filter(date == "2020-04-06") %>% mutate(CFR = round(deaths / cases, digits=3), State = state, state = tolower(State))
